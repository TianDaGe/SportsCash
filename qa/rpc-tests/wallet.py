...
#   c) node1 mines 32 blocks, so now node 0 has 60001enx, node 1 has 4250enx, node2 has none.
#   d) node0 sends 601 enx to node2, in two transactions (301 enx, then 300 enx).
