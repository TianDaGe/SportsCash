Contributing to SportsCash Core
============================

The SportsCash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SportsCash Core project, and is not to be
confused with overall SportsCash Network Protocol consensus changes.

Whether a pull request is merged into SportsCash Core rests with the project merge
...
Patches that change SportsCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the SportsCash consensus, it must have been
...
The project leader is the release manager for each SportsCash Core release.
