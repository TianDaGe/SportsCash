...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SportsCash Core sportscash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sportscash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sportscash transaction") + "\n" +
                               "  sportscash-tx [options] -create [commands]   " + _("Create hex-encoded sportscash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sportscash transaction
