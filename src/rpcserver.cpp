...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SportsCash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SportsCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SportsCash features */
        {"sportscash", "masternode", &masternode, true, true, false},
        {"sportscash", "listmasternodes", &listmasternodes, true, true, false},
        {"sportscash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sportscash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sportscash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sportscash", "masternodedebug", &masternodedebug, true, true, false},
        {"sportscash", "startmasternode", &startmasternode, true, true, false},
        {"sportscash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sportscash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sportscash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sportscash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sportscash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sportscash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sportscash", "mnbudget", &mnbudget, true, true, false},
        {"sportscash", "preparebudget", &preparebudget, true, true, false},
        {"sportscash", "submitbudget", &submitbudget, true, true, false},
        {"sportscash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sportscash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sportscash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sportscash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sportscash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sportscash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sportscash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sportscash", "checkbudgets", &checkbudgets, true, true, false},
        {"sportscash", "mnsync", &mnsync, true, true, false},
        {"sportscash", "spork", &spork, true, true, false},
        {"sportscash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"sportscash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sportscashd, or the -server option to sportscash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> sportscash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:55002/\n";
}
