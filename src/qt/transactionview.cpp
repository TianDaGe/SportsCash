                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Enx from zEnx"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zEnx"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEnx));
