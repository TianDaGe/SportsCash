                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SportsCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SportsCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sportscash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SportsCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about SportsCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SportsCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SportsCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SportsCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a SportsCash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SportsCash Core help message to get a list with possible SportsCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SportsCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SportsCash network", "", count));
}
...
{
    QString strTitle = tr("SportsCash Core"); // default title
