...
/** Utility functions used by the SportsCash Qt UI.
 */
namespace GUIUtil
{
...
// Render SportsCash addresses in monospace font
...
// Parse "sportscash:" URI into recipient object, return true on successful parsing
