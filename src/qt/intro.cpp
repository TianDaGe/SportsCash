...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SportsCash Core"),
     ...
     * override -datadir in the sportscash.conf file in the default data directory
     * (to be consistent with sportscashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
