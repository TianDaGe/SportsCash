...
In order to support loading of multiple wallets in sportscash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sportscash.cpp.
...
Changes to sportscash.cpp
----------------------
sportscash.cpp is the entry point into sportscash-qt, and as such, will require some minor modifications to provide hooks for
