...
* WebSocket: [https://github.com/sportscashproject/insight-api-sportscash#web-socket-api](https://github.com/sportscashproject/insight-api-sportscash#web-socket-api) 
* API: [https://github.com/sportscashproject/insight-api-sportscash#swifttx-transactions](https://github.com/sportscashproject/insight-api-sportscash#swifttx-transactions) 
...
By default, the SportsCash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SportsCash Core daemon:
